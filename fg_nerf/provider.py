...
class fg_NeRFDataset:
    ...
    def collate(self, index):
        ...
        if self.training:
            ...
            poses, dirs = circle_poses(self.device, radius=self.opt.radius_range[1] * 1.5, theta=60, phi=phi, return_dirs=self.opt.dir_text, angle_overhead=self.opt.angle_overhead, angle_front=self.opt.angle_front)
            # poses, dirs = circle_poses(self.device, radius=self.opt.radius_range[1] * 0.75, theta=60, phi=phi, return_dirs=self.opt.dir_text, angle_overhead=self.opt.angle_overhead, angle_front=self.opt.angle_front)
