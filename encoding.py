...
def get_encoder(encoding, input_dim=3, 
    ...
    #     from src.latent_nerf.models.encoders.shencoder import SHEncoder
    #     encoder = SHEncoder(input_dim=input_dim, degree=degree)
    # elif encoding == 'hashgrid':
    #     from src.latent_nerf.models.encoders.gridencoder import GridEncoder
    ...
    if encoding == 'None':
        ...
        from src.latent_nerf.models.encoders.freqencoder import FreqEncoder
