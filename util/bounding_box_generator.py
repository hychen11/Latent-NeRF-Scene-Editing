...
from util.camera import get_rotation_matrix
...
class BoundingBoxGenerator(nn.Module):
    ...
    def __init__(self, n_boxes=1,
                 scale_range_min=[0., 0., 0.],
                 scale_range_max=[0.6, 0.6, 0.6],
                 translation_range_min=[-0.75, -0.75, -0.75],
                 translation_range_max=[0.75, 0.75,0.75],
