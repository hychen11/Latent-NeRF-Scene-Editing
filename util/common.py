...
def transform_to_world(pixels, depth, camera_mat, world_mat, scale_mat=None,
    ...
    scale_mat = scale_mat.to('cuda')
    world_mat.to('cuda') 
    camera_mat=camera_mat.to('cuda') 
    pixels.to('cuda')
    # print(scale_mat.device,world_mat.device,camera_mat.device,pixels.device)
