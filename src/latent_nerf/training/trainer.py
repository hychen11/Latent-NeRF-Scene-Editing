...
class Trainer:
    def __init__(self, cfg: TrainConfig):
        ...
        # print(f"self.exp_path{self.exp_path}")
        self.ckpt_path = make_path(self.exp_path / 'checkpoints')
        self.train_renders_path = make_path(self.exp_path / 'vis' / 'train')
        self.eval_renders_path = make_path(self.exp_path / 'vis' / 'eval')
        self.final_renders_path = make_path(self.exp_path / 'results1')
...
#generate camera pose (intrinsic and rays???)
    #train H:64 W:64 intrinsics[122.94285613 122.94285613  64.          64.        ]
    #render H:160 W:160 intrinsics[153.67857016 153.67857016  80.          80.        ]
    ...
    def evaluate(self, dataloader: DataLoader, save_path: Path, save_as_video: bool = False):
        ...
        for i, data in enumerate(dataloader):
            ...
            if save_as_video:
                ...
                # pred.shape(1280, 1280, 3)
                all_preds.append(pred)
                # print(f"pred_normals.shape{pred_normals.shape}")
                # pred_normals.shape(160, 160, 3)
    ...
    def train_render(self, data: Dict[str, Any]):
        ...
        # print(f"rays_o,rays_d{rays_o,rays_d}")
        ...
        # print(f"outputs['image'].shape:{outputs['image'].shape}")
        #outputs['image'].shape:torch.Size([1, 4096, 4])
        ...
        #only change pred_rgb according to text_z
        loss = loss_guidance
    ...
    def eval_render(self, data, bg_color=None, perturb=False):
        ...
        # print(f"11111{outputs['image'].shape}")
        # 11111torch.Size([1, 40000, 4])
        ...
        if self.nerf.latent_mode:
            ...
            # pred_latent.shape torch.Size([1, 4, 160, 160])
            # 1 25600 4
            if self.cfg.log.skip_rgb:
                ...
                # pred_rgb=pred_latent.permute(0,2,3,1)
                ...
                # pred_rgb = pred_rgb@decoder_matrix
        ...
        # print(f"pred_rgb.shape{pred_rgb.shape},H{H},W{W}")
        # pred_rgb.shapetorch.Size([1, 1280, 1280, 3]),H160,W160
        #  1 1280 1280 3
        ...
        # print(f"outputs_normals['image']{outputs_normals['image'].shape}")
