...
class GuideConfig:
    ...
    text: str="A lego man with a hat"
    ...
    # Guiding mesh
    # shape_path: Optional[str] = "/home/hychen/latent-nerf/shapes/animal.obj"
    shape_path: Optional[str] = "/home/hychen/latent-nerf/shapes/teddy.obj"
...
class LogConfig:
    ...
    exp_root: Path = Path('/data/hychen/final/step2.2/')
